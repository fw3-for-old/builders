 ...
 */
class AddColumn extends AbstractDdlBuilder
{
    //==============================================
    // properties
    //==============================================
    ...
    /**
     * @var ColumnInsertionPosition カラム挿入位置
     */
    protected $insertionPosition    = null;
    ...
    protected function __construct($table, $column)
    {
        ...
        $this->insertionPosition    = ColumnInsertionPosition::factory();
    }
     ...
     * @return  static  このインスタンス
     */
    public function insertAfter($column)
    {
        $this->insertionPosition->after($column);
        return $this;
    }
    ...
    public function build()
    {
        ...
        if ($state['insert_position'] !== null) {
            $ddl[]  = $state['insert_position'];
        }
    ...
    public function getState()
    {
        return array(
            ...
            'insert_position'   => $this->insertionPosition->exists() ? $this->insertionPosition->build() : null,
        );
    }
    ...
    public function __clone()
    {
        ...
        $this->insertionPosition    = clone $this->insertionPosition;
    }
}
