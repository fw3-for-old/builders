 ...
 * サブタイプ：浮動小数点型用桁情報
 */
class FloatingPointDigitTest extends AbstractTest
{
    const CLASS_PATH    = "\\fw3_for_old\\builders\\sql\\ddl\\mysql5_6\\data_types\\numeric_types\\sub_types\\FloatingPointDigit";
    const ERROR_NAME    = FloatingPointDigit::TYPE;
    protected static $NONE_ERROR    = array();

    public function testFactory()
    {
        //----------------------------------------------
        $expected   = 'floating_point_digit';
        $actual     = FloatingPointDigit::TYPE;
        $this->assertSame($expected, $actual);

        //----------------------------------------------
        $decimalPointDigit    = FloatingPointDigit::factory();
        ...
        $decimalPointDigit    = FloatingPointDigit::factory($length, $decimals);
        ...
        $decimalPointDigit    = FloatingPointDigit::factory($length);
    ...
    public function testSetDigit()
    {
        ...
        $decimalPointDigit    = FloatingPointDigit::factory()->setDigit($length, $decimals);
