 ...
 * varchar型
 */
class VarcharTypeTest extends AbstractTest
{
    const CLASS_PATH    = "\\fw3_for_old\\builders\\sql\\ddl\\mysql5_6\\data_types\\string_types\\VarcharType";
    const ERROR_NAME    = VarcharType::TYPE;
    ...
    public function testFactory()
    {
        //----------------------------------------------
        $expected   = 'varchar';
        $actual     = VarcharType::TYPE;
        $this->assertSame($expected, $actual);

        //----------------------------------------------
        $dataType   = VarcharType::factory();
        ...
        $dataType   = VarcharType::factory($length);
    ...
    public function testLength()
    {
        ...
        $dataType   = VarcharType::factory(1);
    ...
    public function testBuild()
    {
        ...
        $expected   = sprintf('varchar(%d)', $length);
        $actual     = $dataType->build();
        $this->assertSame($expected, $actual);
        $this->assertFalse($dataType->hasErrors());
        $this->assertFalse($dataType->hasError(self::ERROR_NAME));
